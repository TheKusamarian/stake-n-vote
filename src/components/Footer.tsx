  ...
  return (
    <div className="flex gap-x-6">
      <Link
        ...
        aria-label="Kusamarian on YouTube"
      >
        <YoutubeIcon />
      </Link>
      <Link
        ...
        className="group hover:text-slate-600"
        aria-label="Kusamarian on Discord"
      >
        <DiscordIcon stroke="currentColor" fill="currentColor" />
      </Link>
      <Link
        href={config.links.twitter}
        className="group hover:text-slate-600"
        aria-label="Kusamarian on X"
      >
        <svg
          className="h-6 w-6"
          aria-hidden="true"
      ...
      <Link
        ...
        className="group hover:text-slate-600"
        aria-label="Kusamarian on GitHub"
      >
        <svg
