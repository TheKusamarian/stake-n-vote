...
const WEB3_THINKERS_PLAYLIST_ID = "PLtyd7v_I7PGkq7KUe3ep3lFLgKG97Z2AO"

export default async function SectionSpaceMonkeys() {
  const data = await fetchLatestVideos(WEB3_THINKERS_PLAYLIST_ID)
  ...
  return (
    <section className="py-16 relative bg-black">
      ...
      <div className="container mx-auto px-4 z-1 mb-10 text-white relative">
        <h2 className="text-5xl font-bold text-center mb-4">WEB3 THINKERS</h2>
